...
kind:"proposal"の項目にはproposal_type("update"または"archive_recommendation")が付く。archive_recommendationはtitleが"Archive recommendation: ..."で始まり、内容変更ではなくnoteのarchiveを人間に提案するもの。
